	...
	<fieldset>
        ...
        <div class="pure-control-group">
            ...
            <select id="gender" name="gender">
                <option value="mężczyzna" {if $form->gender == "mężczyzna"}selected{/if}>mężczyzna</option>
                <option value="kobieta" {if $form->gender == "kobieta"}selected{/if}>kobieta</option>
                <option value="inna" {if $form->gender == "inna"}selected{/if}>inna</option>
            </select>
        </div>
